...
<body>
    <div class="cod-container">
        <div class="form-header">
            ...
            <h1>Formulario<span> empleado</span></h1>
        </div>

        <div class="form-content">
            <form action="/TpfinalApweb/CrearEmpleado" method="POST" id="b" class="cod-form">
               ...
               <div class="input-group">
                ...
                <div class="input-group">
                    <input type="submit" class="form-input" value="Crear Empleado" id="bt">
