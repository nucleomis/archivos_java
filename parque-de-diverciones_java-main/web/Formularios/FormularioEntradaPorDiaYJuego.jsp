...
<body>
    <div class="cod-container">
        ...
        <div class="form-content">
            <form action="/TpfinalApweb/JuegosPorFecha" method="POST" id="b" class="cod-form">
                <div class="form-title">
                    <h3>Entradas<br>por dia y juego</h3>
                </div>
                ...
                <div class="input-group">
                   <label class ="label"for = "juego">Juego </label>
                    <select name="Juego" class="" required >
                        ...
                        for (Juego ju : game){
                            out.println("<option value = "+ju.getNombre()+">"+ju.getNombre()+"</option>");
                        }
