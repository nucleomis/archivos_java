...
<body>
    <div class="cod-container">
        <div class="form-header">
            ...
            <h1>Formulario<span> cliente</span></h1>
        </div>

        <div class="form-content">
            <form action="/TpfinalApweb/CrearCliente" method="POST" id="b" class="cod-form">
               ...
               <div class="input-group">
                ...
                <div class="input-group">
                    <input type="submit" class="form-input" value="Alta cliente" id="bt">
                    <p><a href="/TpfinalApweb/Paneles/PanelClientes.jsp" class="alt-form">Volver</a></p>
                </div>
            </form>
        </div>
