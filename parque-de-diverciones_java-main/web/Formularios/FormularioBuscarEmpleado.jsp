...
<body>
    <div class="cod-container">
        ...
        <div class="form-content">
            <form action="/TpfinalApweb/BuscarEmpleado.jsp" method="POST" id="b" class="cod-form">
                ...
                <div class="input-group">
                    ...
                    <p><a href="/TpfinalApweb/Paneles/PanelConsultaEmpleado.jsp" class="alt-form">Volver</a></p>
                </div>
            </form>
        </div>
