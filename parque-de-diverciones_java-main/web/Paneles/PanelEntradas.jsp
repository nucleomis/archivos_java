...
<html>
    ...
    <body>
        <div class="cod-container">
            ...
            <h1>Panel<span> de Entradas</span></h1>
            </div>
            <h2>
                <div class="input-group">
                <h4 align="center"><a href="/TpfinalApweb/Formularios/FormularioAltaEntrada.jsp" class="alt-form">Alta</a></h4>
                </div>
                <div class="input-group">
                <h4 align="center"><a href="/TpfinalApweb/Paneles/PanelConsultaEntrada.jsp" class="alt-form">Consultas</a></h4>
                </div>
            </h2>
